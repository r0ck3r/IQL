...
public class IQL {
    ...
    private class Join{
        ...
        public String getCommand(){
            ...
            String propType;
            switch (side){
                case JOIN_LEFT: propSide = " LEFT"; break;
                case JOIN_RIGHT: propSide = " RIGHT"; break;
                case JOIN_FULL: propSide = " FULL"; break;
                default: propSide = "";
            }
            switch (type){
                case JOIN_INNER: propType = " INNER"; break;
                case JOIN_OUTER: propType = " OUTER"; break;
                default: propType = "";
            }
    ...
    private Row parseRow(String row) throws RowFormatException {
        ...
        if(delimiterIndex == row.length()-2){
            ...
            switch (typeChar){
                ...
                case 'd' : type = RT_D; break;
                default: throw new RowFormatException();
            }
    ...
    private Object prepareForRow(Row row, Object data){
        switch (row.type){
            ...
            case RT_D: return parseDate(data);
            default: throw new RowFormatException();
        }
    }
    ...
    public IQL where(String what, String operation, Object value){
        ...
        switch (operation){
            case EQUAL: cOperation = "="; break;
            case NOT_EQUAL: cOperation = "<>"; break;
            case MORE: cOperation = ">"; break;
            case MORENEQUAL: cOperation = ">="; break;
            case LESS: cOperation = "<"; break;
            case LESSNEQUAL: cOperation = "<="; break;
            case ISNULL: cOperation = "IS NULL"; withoutData = true; break;
            case ISNTNULL: cOperation = "IS NOT NULL"; withoutData = true; break;
            case LIKE: cOperation = "LIKE"; break;
            default: cOperation = "=";
        }
        ...
        try {
            ...
            for(PreparedData preparedData : this.preparedQueryData){
                switch (preparedData.type){
                    ...
                    case RT_B: ps.setBoolean(i++, (boolean) preparedData.data); break;
                }
            }
            reset();
            return ps;
    ...
    public String getSQL(){
        ...
        for(PreparedData preparedData : preparedQueryData){
            switch (preparedData.type){
                ...
                case RT_I:
                case RT_D:
                    qf.setInt((int) preparedData.data); break;
                case RT_B:
                    qf.setBoolean((boolean) preparedData.data); break;
            }
        }
        reset();
        return qf.toString();
    ...
    private void compileQuery(){
        ...
        switch (opType){
            case INSERT: compileInsert(); break;
            case UPDATE: compileUpdate(); break;
